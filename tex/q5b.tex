...
\begin{document}
  ...
  \begin{abstract}
    ...
    unconditional.
    The metric coefficients have since been determined: $A_H = 2$ by
    Q10~\cite{Beau2026q10} and $A_z = 2$ by Q8~\cite{BeauQ8}, giving
    $g^{\mu\nu} = \mathrm{diag}(-A_\tau,\, 2,\, 2,\, 2)$ with $A_\tau$ the sole
